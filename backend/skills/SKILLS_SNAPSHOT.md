<skills>
  ...
  <skill name="get_weather" path="skills/get_weather/SKILL.md">
    <description>Deprecated sample skill. Do not use for ClawTeam tumor board consultation.</description>
  </skill>
